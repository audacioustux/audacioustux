...
There are constraints and consequences. We only have 24 hours a day, a brain that can't hold an infinite amount of information and a body that needs rest. So, we need to prioritize. Our expectations should be educated, and our decisions should be informed... But most importantly, we need to make progress. I've seen some people who are so obsessed with making the right decision, that they end up taking no action at all. It's like running a recursive function with no base case - you have to get back to the base case and return some value at some point, or you'll end up with a [stack overflow](https://en.wikipedia.org/wiki/Stack_overflow).  
...
Again, a reminder, whether you have the state of mind to do something is also part of your mindset. If you're addicted to social media, or something that wastes too much of your time, that contradicts saying you've a productivity mindset. If you're failing to sleep on time, that contradicts saying you have a healthy mindset. If you really want to learn, you must reach out to people, ask questions, and less care about humility... and so on. But don't worry...
